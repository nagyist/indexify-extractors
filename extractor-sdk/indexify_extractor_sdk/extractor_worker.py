...
class ExtractorWorker:
    def __init__(
        self, extractor_metadata_store: ExtractorMetadataStore, workers: int = 1
    ) -> None:
    ...
    def submit(
        self, extractor: str, inputs: Dict[str, Any], params: Dict[str, Any]
    ) -> Dict[str, List[Any]]:
        extractor_module_class = self._extractor_metadata_store.extractor_module_class(
            extractor
        )
